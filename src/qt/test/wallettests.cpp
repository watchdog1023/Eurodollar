...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<EurodollarAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_eurodollar-qt -platform xcb      # Linux
//     src/qt/test/test_eurodollar-qt -platform windows  # Windows
//     src/qt/test/test_eurodollar-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = EurodollarUnits::formatWithUnit(unit, balance, false, EurodollarUnits::separatorAlways);
    ...
    // Amount input
    EurodollarAmountField* amountInput = receiveCoinsDialog.findChild<EurodollarAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: eurodollar:")) != -1);
