...
/** Eurodollar unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EurodollarUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EurodollarUnits(QObject *parent);

    /** Eurodollar units.
      @note Source: https://en.eurodollar.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        EUD,
...
typedef EurodollarUnits::Unit EurodollarUnit;
