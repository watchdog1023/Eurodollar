...
{
    BOOST_CHECK(TestSplitHost("www.eurodollar.org", "www.eurodollar.org", -1));
    BOOST_CHECK(TestSplitHost("[www.eurodollar.org]", "www.eurodollar.org", -1));
    BOOST_CHECK(TestSplitHost("www.eurodollar.org:80", "www.eurodollar.org", 80));
    BOOST_CHECK(TestSplitHost("[www.eurodollar.org]:80", "www.eurodollar.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:2077", "127.0.0.1", 2077));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:2077", "127.0.0.1", 2077));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:2077", "::ffff:127.0.0.1", 2077));
    BOOST_CHECK(TestSplitHost("[::]:2077", "::", 2077));
    BOOST_CHECK(TestSplitHost("::2077", "::2077", -1));
    BOOST_CHECK(TestSplitHost(":2077", "", 2077));
    BOOST_CHECK(TestSplitHost("[]:2077", "", 2077));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:2077", "127.0.0.1:2077"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:2077", "[::]:2077"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
