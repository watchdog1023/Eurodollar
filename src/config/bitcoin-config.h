/* src/config/eurodollar-config.h.  Generated from eurodollar-config.h.in by configure.  */
/* src/config/eurodollar-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Eurodollar Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Eurodollar Core"
...
#define PACKAGE_BUGREPORT "https://github.com/eurodollar/eurodollar/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Eurodollar Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Eurodollar Core 0.16.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "eurodollar"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://eurodollarcore.org/"
