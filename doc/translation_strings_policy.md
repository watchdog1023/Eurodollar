...
This document provides guidelines for internationalization of the Eurodollar Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `eurodollar_en.ts` remains unchanged.
