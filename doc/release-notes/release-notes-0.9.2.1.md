Eurodollar Core version 0.9.2.1 is now available from:

  https://eurodollar.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 EUD to 0.01 EUD
...
- Fix "Start eurodollar on system login"
