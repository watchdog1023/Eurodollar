Eurodollar Core version *0.15.0.1* is now available from:

  <https://eurodollar.org/bin/eurodollar-core-0.15.0.1/>

and

  <https://eurodollarcore.org/bin/eurodollar-core-0.15.0.1/>
