Eurodollar version 0.5.4 is now available for download at:
http://sourceforge.net/projects/eurodollar/files/Eurodollar/eurodollar-0.5.4/
...
http://gitorious.org/eurodollar/eurodollard-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Eurodollar-Qt notifications under Growl 1.3.
Increase required age of Eurodollar-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxEurodollar properly when installing Eurodollar-Qt over it. (Windows)
