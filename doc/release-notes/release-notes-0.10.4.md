Eurodollar Core version 0.10.4 is now available from:

  <https://eurodollar.org/bin/eurodollar-core-0.10.4/>
...
- #6953 `43c2789` Split eurodollar-tx into its own package
- #6953 `dfe0d4d` Include eurodollar-tx binary on Debian/Ubuntu
