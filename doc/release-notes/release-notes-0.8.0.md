Eurodollar-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/eurodollar/files/Eurodollar/eurodollar-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Eurodollar
...
New/changed settings (command-line or eurodollar.conf file)
--------------------------------------------------------
