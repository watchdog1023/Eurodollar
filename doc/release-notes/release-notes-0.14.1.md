Eurodollar Core version 0.14.1 is now available from:

  <https://eurodollar.org/bin/eurodollar-core-0.14.1/>
...
here:
[reducing-eurodollard-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` eurodollar-tx input verification (awemany, jnewbery)
