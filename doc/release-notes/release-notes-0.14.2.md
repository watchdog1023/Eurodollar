Eurodollar Core version 0.14.2 is now available from:

  <https://eurodollar.org/bin/eurodollar-core-0.14.2/>
...
(in Eurodollar Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Eurodollar-Qt when using coin
...
- #10228 `ae479bc` Regenerate eurodollar-config.h as necessary (theuni)
