Eurodollar Core version 0.13.2 is now available from:

  <https://eurodollar.org/bin/eurodollar-core-0.13.2/>
...
- #8908 `4a974b2` Update eurodollar-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow eurodollar-tx to create v2 transactions (btcdrak)
