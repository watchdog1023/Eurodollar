Eurodollar Core version 0.9.4 is now available from:

  https://eurodollar.org/bin/0.9.4/
...
this update is incompatible with the Eurodollar system and could lead to consensus
forks.

Eurodollar Core released binaries from https://eurodollar.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~eurodollar/+archive/ubuntu/eurodollar
- A third-party or self-compiled Eurodollar Core

upgrade to Eurodollar Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
