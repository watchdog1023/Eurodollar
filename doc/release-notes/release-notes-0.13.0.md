Eurodollar Core version 0.13.0 is now available from:
...
eurodollar-cli: arguments privacy
------------------------------
...
The two phases are distinct in the Eurodollar-Qt GUI. During the first one,
