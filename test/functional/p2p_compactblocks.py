...
# TestNode: A peer we use to send messages to eurodollard, and store responses.
...
class CompactBlocksTest(EurodollarTestFramework):
    ...
    # This test actually causes eurodollard to (reasonably!) disconnect us, so do this last.
    ...
    # Test that eurodollard requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for eurodollard to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # eurodollard will not send blocktxn responses for blocks whose height is
