...
By default, eurodollard will dump mempool on shutdown and
...
class MempoolPersistTest(EurodollarTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give eurodollard a second to reload the mempool
        ...
        self.log.debug("Prevent eurodollard from writing mempool.dat to disk. Verify that `savemempool` fails")
