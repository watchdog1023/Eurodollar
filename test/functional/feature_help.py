#!/usr/bin/env python3
# Copyright (c) 2018 The Eurodollar Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting eurodollar with -h works as expected."""
import subprocess

from test_framework.test_framework import EurodollarTestFramework
from test_framework.util import assert_equal

class HelpTest(EurodollarTestFramework):
    ...
    def run_test(self):
        self.log.info("Start eurodollar with -h for help text")
        ...
        self.log.info("Start eurodollar with -version for version information")
