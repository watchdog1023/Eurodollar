...
class BIP66Test(EurodollarTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # eurodollard is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and eurodollard produces more specific reject
            # reasons.
